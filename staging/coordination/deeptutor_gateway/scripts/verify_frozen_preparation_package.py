...
def main() -> int:
    ...
    expected = {
        ...
        "desktop_word_source_reference": ["reference_issues", "image_references", "block_ranges"],
        "desktop_word_ranges": ["原文选段范围不正确，请重新选择。"],
        "desktop_workbench.word_range_selection": ["合并多个分散段落", "加入当前段", "清空选段"],
