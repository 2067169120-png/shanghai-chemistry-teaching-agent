...
def main():
    ...
    (package/'BUILD.json').write_text(json.dumps({'version':'0.1.87','source_commit':os.environ['GITHUB_SHA'],
    ...
    shutil.make_archive(str(release/'ShanghaiChem-0.1.87-Windows-x64'),'zip',package.parent,package.name)
