...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='shchem-detached-') as temporary:
        ...
        # Do not propagate development search paths into these child EXE runs.
    ...
    (package/'BUILD.json').write_text(json.dumps({'version':'0.1.92','source_commit':os.environ.get('SHCHEM_SOURCE_SHA', os.environ['GITHUB_SHA']),
    ...
    shutil.make_archive(str(release/'ShanghaiChem-0.1.92-Windows-x64'),'zip',package.parent,package.name)
