...
- [教案知识索引与覆盖表](knowledge/lectures/coverage.json)：46份复习讲义的262条知识、54条方法及60条易错/待核提醒，每项带原文件SHA和区块位置。另52份练习或检测文件的完整图文已在本机资料中，不另把它们伪装成46讲之外的新教案摘要。
