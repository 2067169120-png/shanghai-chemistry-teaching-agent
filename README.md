...
当前软件版本为 0.1.47，具体批次见[更新记录](CHANGELOG.md)。Word 原生提取、标签体系、依赖感知选题和材料驱动出题的实际进度及验收边界见[教师工作台路线图](integrations/deeptutor_shchem_v1/TEACHER_WORKBENCH_ROADMAP.md)。提示词约束与已经实现的功能分开记录。
