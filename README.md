...
当前版本为 **0.1.71**，恢复通过字体与记录检查的Word旧式WMF公式预览，并继续支持自动标签核对、多段选材和两课时讲练参考。原教案、明确关联的教材知识与当前题目标签共用备课参考；现成Word仍是主内容，不重写或重复导入98份资料。全库标记、全书与全专题深度蒸馏、图片识别到个人逐题库和真实分页预览仍未全部完成。具体见[更新记录](CHANGELOG.md)及[教师工作台路线图](integrations/deeptutor_shchem_v1/TEACHER_WORKBENCH_ROADMAP.md)。

## 旧公式可读性修复与当前缺项（0.1.71）
...
当前仍为：**2742/3573道有主知识点，2556/3573道有教材映射，去重1267道至少缺一项**；2734道原考试类型缺依据，不能按教案标题猜测一模、二模或校考。46份讲义有262条知识、82条方法、73条提醒、14条讲练流程，7讲有流程、39讲尚缺；五册教材383条既有概念索引，本轮未新增蒸馏条目，全书知识、例题、图表深度整理仍待完成。
