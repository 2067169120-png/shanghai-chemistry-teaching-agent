...
' ASCII-only launcher: current trial, then the two retained rollback builds.
...
exePath = ""
For Each packageName In Array("desktop_package_0.1.54", "desktop_package_0.1.53", "desktop_package_0.1.52")
